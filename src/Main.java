...
class Main extends JFrame {
    ...
    void start() {
        ...
        var pane = this.configureOverallLayout();
        this.configureOverallContainer(pane);
    }


    private JSplitPane configureOverallLayout() {
    ...
    private void configureOverallContainer(JSplitPane pane) {
